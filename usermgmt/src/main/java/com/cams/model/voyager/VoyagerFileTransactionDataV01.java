...
@Entity
@Table(name="VOYAGER_FILE_TRANS_DATAV01")
public class VoyagerFileTransactionDataV01 {
	
	@Id 
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="v_file_trans_datav01_seq")
	@SequenceGenerator(
			name="v_file_trans_datav01_seq",
			sequenceName="v_file_trans_datav01_sequence",
			allocationSize=1
		)
	@Column(name="ID")
	private int id;
	...
	public VoyagerFileTransactionDataV01(int id,String dt870_vehicle_vin_num, MyLease mylease,VoyagerProdCD voyager){
	...
	public VoyagerFileTransactionDataV01(){
